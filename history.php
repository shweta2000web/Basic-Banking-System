        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="./history.php"><span class="fa fa-info fa-lg"></span> Transaction History</a></li>
                </ul>
        </div>
      </div>
    </nav>
...
<!--TRANSACTION HISTORY TABLE START-->
  <div class="row row-content">
        <div class="col-12 offset-sm-1 col-sm-10">
            <h2 style="padding-top: 120px ;text-align: center;"><b><i>TRANSACTION HISTORY</i></b></h2>
